...
import 'package:fresh_notes/data/notes/cloud/models/cloud_note_repository.dart';
import 'package:fresh_notes/data/notes/cloud/models/m_cloud_note.dart';
import 'package:fresh_notes/data/notes/local/local_notes_repository.dart';
...
class LocalNotesMockImpl extends LocalNotesRepository {
  LocalNotesMockImpl({
    this.notes = const [],
  });
