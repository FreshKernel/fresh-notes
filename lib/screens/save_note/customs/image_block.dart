...
// import 'package:flutter_quill_extensions/embeds/widgets/video_app.dart';
// import 'package:flutter_quill_extensions/embeds/widgets/youtube_video_app.dart';
...
// typedef ImageEmbedBuilderOnRemoveImage = Future<void> Function(File imageFile);

// class ImageEmbedBuilder extends EmbedBuilder {
//   final ImageEmbedBuilderOnRemoveImage onRemoveImage;

//   ImageEmbedBuilder({required this.onRemoveImage});
...
//                     );
//                     navigator.pop();
//                     await onRemoveImage(File(imageUrl));
//                   },
//                 );
//                 return Padding(
...
//                   final navigator = Navigator.of(context);
//                   final imageSaved = await GallerySaver.saveImage(imageUrl);
//                   if (!imageSaved) {
//                     messenger.showSnackBar(SnackBar(content: Text('Saved'.i18n)));  
//                   }
